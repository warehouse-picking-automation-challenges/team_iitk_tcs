...
public:
    ...
    bool checkProtectiveStopCallback(iitktcs_msgs_srvs::CheckClearProtectiveStop::Request &req, iitktcs_msgs_srvs::CheckClearProtectiveStop::Response &res)
    {
...
int main(int argc, char **argv) {
    ...
    ros::ServiceServer service_check_protective_stop = nh.advertiseService<iitktcs_msgs_srvs::CheckClearProtectiveStop::Request, iitktcs_msgs_srvs::CheckClearProtectiveStop::Response>
